        ...
        <div className={styles.grid}>
          <div className={styles.info}>
            ...
            <p className={styles.infoText}>
              Whether you&apos;re looking for a senior engineer to join your team, want to
              collaborate on an open-source project, or just want to connect — feel free to reach
              out.
            </p>

            <ul className={styles.contactItems} aria-label="Contact information">
              <li className={styles.contactItem}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
                  <rect width="20" height="16" x="2" y="4" rx="2" />
                  <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" />
                </svg>
                <a href={socialLinks.email.url}>{siteConfig.author.email}</a>
              </li>
              <li className={styles.contactItem}>
